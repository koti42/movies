            ...
            <div className="px-4 md:px-12 py-12">
                <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-8">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            <li>
                                <Link to="/movies?genre=action" className="text-gray-400 hover:text-white transition-colors">
                                    Action
                                </Link>
                            </li>
                            <li>
                                <Link to="/movies?genre=comedy" className="text-gray-400 hover:text-white transition-colors">
                                    Comedy
                                </Link>
                            </li>
                            <li>
                                <Link to="/movies?genre=drama" className="text-gray-400 hover:text-white transition-colors">
                                    Drama
                                </Link>
                            </li>
                            <li>
                                <Link to="/movies?genre=thriller" className="text-gray-400 hover:text-white transition-colors">
                                    Thriller
                                </Link>
                            </li>
                        </ul>
