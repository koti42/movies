...
import { getPopularTVShows, getTopRatedTVShows } from '../services/api';
        ...
        <div className="min-h-screen pt-24 px-4 md:px-12">
            ...
            {loading ? (
                ...
                <div className="text-center py-12">
                    ...
                    <button onClick={() => fetchShows(page)} className="btn-primary mt-4">
                        Retry
                    </button>
                </div>
            ) : (
                    ...
                    {totalPages > 1 && (
                        <div className="flex justify-center items-center gap-4 mb-12">
                            ...
                            <div className="flex items-center gap-2">
                                {page > 2 && (
                                    <>
                                        <button onClick={() => fetchShows(1)} className="w-10 h-10 rounded-full bg-netflix-gray hover:bg-netflix-red transition-colors">
                                            1
                                        </button>
                                ...
                                {page > 1 && (
                                    <button onClick={() => fetchShows(page - 1)} className="w-10 h-10 rounded-full bg-netflix-gray hover:bg-netflix-red transition-colors">
                                        {page - 1}
                                    </button>
                                )}
                                ...
                                {page < totalPages - 1 && (
                                    <>
                                        ...
                                        <button onClick={() => fetchShows(totalPages)} className="w-10 h-10 rounded-full bg-netflix-gray hover:bg-netflix-red transition-colors">
                                            {totalPages}
                                        </button>
                                    </>
                                )}
